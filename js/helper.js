...
var HTMLfooter = '<li class="flex-item"><span class="footImg"><img src="%imageSource%" class="img-responsive"></span><span class="footer-text">%data%</span></li>';

var HTMLbioPic = '<img src="%data%" class="biopic">';
var HTMLWelcomeMsg = '<span class="welcome-message">%data%</span>';

var HTMLmenuOptions = '<li><a href="#"><img src="%data%" class="img-responsive"></a></li>';
...
var HTMLprojectImage = '<a href="#"><img src="%data%" class="img-responsive" alt="Project Image"></a>';
